...
/**
 * Send sign-in verification OTP
 */
const sendSigninOTPEmail = async (email, otp, userName) => {
    try {
        console.log(`\n=== DEV MODE: Sign-in OTP for ${email} is ${otp} ===\n`);
        const transporter = createTransporter();

        const mailOptions = {
            from: `"To-Do List App" <${config.email.from}>`,
            to: email,
            subject: 'Sign-in Verification - To-Do List App',
            html: `
                <!DOCTYPE html>
                <html>
                <head>
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            <p>Hello ${userName || 'User'},</p>
                            <p>We noticed a login attempt to your account. To complete your sign-in, please enter the following verification code:</p>
                            ...
                            <p>If you didn't attempt to sign in, please secure your account by changing your password immediately.</p>
                        </div>
                        <div class="footer">
                            <p>&copy; 2026 To-Do List App. All rights reserved.</p>
                        </div>
        ...
        const info = await transporter.sendMail(mailOptions);
        console.log('✅ Sign-in OTP email sent:', info.messageId);
        return { success: true, messageId: info.messageId };
